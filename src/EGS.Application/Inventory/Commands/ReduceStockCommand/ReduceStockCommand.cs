...
{
    public class ReduceStockCommand : IRequestWrapper<InventoryTransactionDto>
    {
        public long? BookId { get; set; }
        public int Quantity { get; set; }
    }

    public partial class ReduceStockCommandHandler : IRequestHandlerWrapper<ReduceStockCommand, InventoryTransactionDto>
    {
        private readonly IInventoryRepository _inventoryRepository;
        private readonly IDateTime _dateTime;
        private readonly ICurrentUserService _currentUserService;
        private readonly IMapper _mapper;
        public ReduceStockCommandHandler(IInventoryRepository inventoryRepository, IDateTime dateTime, 
        ...
        public async Task<ServiceResult<InventoryTransactionDto>> Handle(ReduceStockCommand request, CancellationToken cancellationToken)
        {
